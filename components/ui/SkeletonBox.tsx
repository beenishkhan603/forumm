// relative rounded-xl my-6 ml-2 mx-[22px] cursor-pointer w-[85%] max-w-[1500px] sm:w-[23%] pb-6

export default function SkeletonBox() {
  return (
    <div
      role="status"
      className="flex-1 border border-gray-200 rounded-xl shadow-md animate-pulse p-8 my-6 ml-2 mx-[22px] w-[85%] max-w-[1500px] sm:w-[23%] pb-6"
    >
