        ...
        >
          ...
          <Box>
            <Form onSubmit={handleSubmit} error={error}>
              ...
              <SearchInput
                className=" bg-[#96B7E8] placeholder-white rounded-3xl focus:outline-none focus:ring-0 border-none"
                addValueInOptions
                required={true}
              ...
              >
                ...
                <span className="mt-[2px]">
                  Can&apos;t find your university or school? Please proceed with
                  the sign-up process, and we&apos;ll handle it from here.
                </span>
              </div>
              <Button
                buttonType="submit"
